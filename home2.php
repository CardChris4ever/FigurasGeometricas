...
if (!isset($_SESSION["username"])) { // Verificar si el usuario no ha iniciado sesión
...
<body>
    ...
    <section class="figures">
        ...
        <div class="box">
            ...
            <div >
        <button class="BotonBonito"> Click Aqui</button>
        <br><br>
        <button class="Hamburguesa">
            <div class="lineaHamburguesa"></div>
            <div class="lineaHamburguesa"></div>
            <div class="lineaHamburguesa"></div>
        ...
        echo "Hola $username, bienvenido a la página protegida.";
        ?>
        </div>
...
<!-- HTML para el botón de cerrar sesión -->
